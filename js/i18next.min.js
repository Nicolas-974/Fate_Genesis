! function(t, e) {
    ...
    class m extends i {
        ...
        addResourceBundle(t, e, s, i, n) {
            ...
            i ? u(h, s, n) : h = {
                ...h,
                ...s
            }, a(this.data, r, h), o.silent || this.emit("added", t, e, s)
        }
    ...
    class b extends i {
        ...
        translate(t, e, s) {
            ...
            } else if (m && "string" == typeof f && "[object Array]" === d) c = c.join(f), c && (c = this.extendTranslation(c, t, e, s));
            else {
                let i = !1,
                    r = !1;
                const u = void 0 !== e.count && "string" != typeof e.count,
                    p = b.hasDefaultValue(e),
        ...
        static hasDefaultValue(t) {
            ...
            for (const s in t)
                if (Object.prototype.hasOwnProperty.call(t, s) && e === s.substring(0, 12) && void 0 !== t[s]) return !0;
            return !1
        }
    }
    ...
    class R {
        ...
        getRule(t) {
            ...
            if (this.shouldUseIntlApi()) try {
                return new Intl.PluralRules(f(t), {
    ...
    class j {
        ...
        addCached(t, e) {
            this.formats[t.toLowerCase().trim()] = P(e)
        }
        format(t, e, s) {
            let i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
    ...
    class V extends i {
        constructor() {
            ...
            var i;
            if (super(), this.options = I(t), this.services = {}, this.logger = s, this.modules = {
                    external: []
        ...
        init() {
            ...
            if (this.options = {
                ...
                }), !e || this.options.interpolation.format && this.options.interpolation.format !== o.interpolation.format || (n.formatter = r(e), n.formatter.init(n, this.options), this.options.interpolation.format = n.formatter.format.bind(n.formatter)), n.interpolator = new C(this.options), n.utils = {
                    hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
                }, n.backendConnector = new E(r(this.modules.backend), n.resourceStore, n, this.options), n.backendConnector.on("*", (function(e) {
            ...
            if (this.format = this.options.interpolation.format, i || (i = T), this.options.fallbackLng && !this.services.languageDetector && !this.options.lng) {
        ...
        reloadResources(t, e, s) {
            const i = n();
            return t || (t = this.languages), e || (e = this.options.ns), s || (s = T), this.services.backendConnector.reload(t, e, (t => {
                i.resolve(), s(t)
            })), i
        }
        use(t) {
        ...
        cloneInstance() {
            ...
            }, s && (n.store = new m(this.store.data, i), n.services.resourceStore = n.store), n.translator = new b(n.services, i), n.translator.on("*", (function(t) {
                for (var e = arguments.length, s = new Array(e > 1 ? e - 1 : 0), i = 1; i < e; i++) s[i - 1] = arguments[i];
                n.emit(t, ...s)
    ...
    const A = V.createInstance();
    return A.createInstance = V.createInstance, A
}));